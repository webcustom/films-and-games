@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between paginationEl">
        <div class="flex justify-between flex-1 sm:hidden paginationEl__previousNext">
        ...
        <div class="paginationEl__flex hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            ...
            <div class="paginationEl__controlls">
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    @if ($paginator->onFirstPage())
                        {{-- <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span class="paginationEl__arrow relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-l-md leading-5 dark:bg-gray-800 dark:border-gray-600" aria-hidden="true">
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page" class="paginationEl__num _active">
